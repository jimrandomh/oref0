...
var determine_basal = function determine_basal(glucose_status, currenttemp, iob_data, profile, autosens_data, meal_data, microBolusAllowed, reservoir_data) {
    ...
    if (abortReason) {
        if (currenttemp.rate >= profile_current_basal) { // high temp is running
            return {
            ...
            return {
                reason: abortReason + ". Temp " + currenttemp.rate + " <= current basal " + profile_current_basal + "U/hr; doing nothing. "
            };
        }
    }
